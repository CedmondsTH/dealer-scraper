...
class DataService:
    ...
    def _standardize_dealer_record(self, dealer: Dict[str, Any], 
        ...
        try:
            ...
            name = data_cleaner.normalize_name(dealer.get("name", ""))
            if not name:
                return None
            
            # Process address
            street = dealer.get("street", "")
            city = data_cleaner.normalize_city(dealer.get("city", ""))
            ...
            phone = data_cleaner.extract_phone_number(dealer.get("phone", ""))
            website = data_cleaner.normalize_website(dealer.get("website", ""))
