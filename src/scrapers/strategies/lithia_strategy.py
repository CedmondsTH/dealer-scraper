...
class LithiaStrategy(ScraperStrategy):
    ...
    def can_handle(self, html: str, page_url: str) -> bool:
        ...
        is_lithia_page = "lithia" in page_url.lower() or "lithia" in html.lower()
    ...
    def extract_dealers(self, html: str, page_url: str) -> List[Dict[str, Any]]:
        ...
        print(
            f"DEBUG: Lithia strategy extracted {len(dealers)} dealers", file=sys.stderr
        )
        return dealers

    def _extract_dealer_from_info_window(
        self, li_element, page_url: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if phone_el and phone_el.has_attr("data-click-to-call-phone"):
                ...
                phone_val = li_element.select_one(
                    ".tel[data-click-to-call='Sales'] .value"
                )
                if phone_val:
            ...
            print(
                f"DEBUG: Error extracting dealer from Lithia info-window: {e}",
                file=sys.stderr,
            )
            return None
