...
from src.scrapers.strategies.courtesy_automotive_strategy import \
    CourtesyAutomotiveStrategy
from src.scrapers.strategies.dealercom_content_blocks_strategy import \
    DealerDotComContentBlocksStrategy
from src.scrapers.strategies.generic_dealer_strategy import \
    GenericDealerStrategy
from src.scrapers.strategies.group1_automotive_strategy import \
    Group1AutomotiveStrategy
from src.scrapers.strategies.hudson_automotive_strategy import \
    HudsonAutomotiveStrategy
...
from src.scrapers.strategies.learned_rule_strategy import \
    LearnedRuleExtractorStrategy
from src.scrapers.strategies.lithia_strategy import LithiaStrategy
from src.scrapers.strategies.overfuel_locations_strategy import \
    OverfuelLocationsStrategy
from src.scrapers.strategies.ray_skillman_strategy import RaySkillmanStrategy
from src.scrapers.strategies.sonic_dealercom_strategy import \
...
def initialize_strategies() -> None:
    ...
    logger.info(
        f"Initialized {len(scraper_registry.get_strategies())} scraping strategies"
    )
